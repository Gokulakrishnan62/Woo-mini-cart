...
<div class="mcw-products" style="<?php echo empty($data['show_cart_button_in_footer']) ? 'height: 60vh; ' : 'height: 55vh; '; ?> <?php echo esc_attr($data['style']['body']); ?>">
            ...
            <div class="mcw-product" style="color: currentColor;"
                ...
                <div style="display: flex; flex-direction: column; width: 75%; gap: 6px;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <div class="mcw-quantity-container" style="display: flex; align-items: center; margin-top: 6px;">
    ...
    <?php } else { ?>
        <h1 style="color: currentColor">i am empty</h1>
    <?php } ?>
</div>
...
<div style="position: absolute; width: 100%; bottom: 0;">
    <?php if (!$cart->is_empty()) { ?>
        <div class="mcw-coupon" style="<?php echo esc_attr($data['style']['coupon']); ?>">
            <?php if (!empty($applied_coupons)) { ?>
                <div id="mcw-coupon-list" style="padding-left: 20px; width: 100%; <?php echo (count($applied_coupons) > 2 ) ? 'height: 70px; overflow: auto;' : ''; ?>">
    ...
    <div class="mcw-footer" style="<?php echo esc_attr($data['style']['footer']); ?>">
        <div>
        <span style="display: flex; gap: 6px; justify-content: space-between; padding: 0 35px;">
            Subtotal :<?php echo $cart->get_cart_total(); ?>
        </span>
        </div>

        <div class="mcw-actions">
            <button class="mcw-action" style="<?php echo esc_attr($data['style']['action']); ?>">
                <?php echo esc_html($data['checkout_cta_text']); ?>
            </button>
            <button class="mcw-action" style="<?php echo esc_attr($data['style']['action']); ?>">
                <?php echo esc_html($data['continue_cta_text']); ?>
            </button>

            <?php if (!empty($data['show_cart_button_in_footer'])) { ?>
                <button class="mcw-action" style="<?php echo esc_attr($data['style']['action']); ?>">
                    <?php echo esc_html($data['cart_cta_text']); ?>
                </button>
            <?php } ?>
        </div>
...
<!--    </div>-->
<!--    <div>coupon discount amount-->
<!--        --><?php //echo  $cart->get_cart_discount_total(); ?>
<!--    </div>-->
<!--    <div>cart total-->
